...
_CAMPAIGNS: dict[str, Any] = {
    "Eye of the North": build_eotn_campaign_specs,
    "Nightfall": build_nightfall_campaign_specs,
    "Prophecies": build_prophecies_campaign_specs,
    "Fissure of Woe": _build_fow_specs,
}
...
def _draw_campaign_picker() -> None:
    ...
    PyImGui.text_colored("Run a full campaign in order; pick the phase to start from.", MUTED)
    PyImGui.spacing()
